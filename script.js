  ...
  document.getElementById("content").innerHTML = `
    <div class="page-wrap" style="width: 100%; max-width: 480px; margin: 0 auto; padding: 12px; box-sizing: border-box;">
      ...
      <div style="display: flex !important; flex-direction: row !important; flex-wrap: nowrap !important; gap: 4px; overflow-x: auto !important; padding-bottom: 8px; margin-bottom: 12px; -webkit-overflow-scrolling: touch; width: 100%;">
        ...
        <button id="tabLpDatang" onclick="switchSubMenuLaporan('datang')" style="flex: 0 0 auto !important; width: auto !important; min-width: 75px; padding: 6px 10px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 6px; font-size: 11px; font-weight: 600; cursor: pointer; white-space: nowrap;">Masuk</button>
        <button id="tabLpMusnah" onclick="switchSubMenuLaporan('musnah')" style="flex: 0 0 auto !important; width: auto !important; min-width: 75px; padding: 6px 10px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 6px; font-size: 11px; font-weight: 600; cursor: pointer; white-space: nowrap;">Musnah</button>
        <button id="tabLpOpname" onclick="switchSubMenuLaporan('opname')" style="flex: 0 0 auto !important; width: auto !important; min-width: 75px; padding: 6px 10px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 6px; font-size: 11px; font-weight: 600; cursor: pointer; white-space: nowrap;">Opname</button>
