...
// ================= GERBANG UTAMA PUSAT LAPORAN & RIWAYAT (COMPACT & FULL DATA) =================
function renderPusatLaporanMenu() {
  ...
  document.getElementById("content").innerHTML = `
    <div class="page-wrap" style="width: 100%; max-width: 480px; margin: 0 auto; padding: 10px; box-sizing: border-box;">
      <div class="bin-header" style="margin-bottom: 12px;">
        <div class="bin-title" style="font-size: 15px; font-weight: bold; color: #fff;"><i class="fa-solid fa-folder-open"></i> PUSAT LAPORAN & RIWAYAT</div>
        <div class="bin-subtitle" style="font-size: 10px; opacity: 0.6;">Living Plaza Balikpapan — Kontrol Data Logistik</div>
      </div>

      <div style="display: flex; gap: 3px; overflow-x: auto; padding-bottom: 5px; margin-bottom: 12px; -webkit-overflow-scrolling: touch; scrollbar-width: none;">
        <button id="tabLpBincard" class="active" onclick="switchSubMenuLaporan('bincard')" style="flex: 0 0 auto; padding: 4px 6px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 4px; font-size: 9px; font-weight: 600; cursor: pointer; white-space: nowrap;">Bin Card</button>
        <button id="tabLpDatang" onclick="switchSubMenuLaporan('datang')" style="flex: 0 0 auto; padding: 4px 6px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 4px; font-size: 9px; font-weight: 600; cursor: pointer; white-space: nowrap;">Masuk</button>
        <button id="tabLpMusnah" onclick="switchSubMenuLaporan('musnah')" style="flex: 0 0 auto; padding: 4px 6px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 4px; font-size: 9px; font-weight: 600; cursor: pointer; white-space: nowrap;">Musnah</button>
        <button id="tabLpOpname" onclick="switchSubMenuLaporan('opname')" style="flex: 0 0 auto; padding: 4px 6px; background: #1e293b; border: 1px solid #334155; color: #fff; border-radius: 4px; font-size: 9px; font-weight: 600; cursor: pointer; white-space: nowrap;">Opname</button>
        <button id="tabLpMatriks" onclick="switchSubMenuLaporan('matriks')" style="flex: 0 0 auto; padding: 4px 6px; background: #1e293b; border: 1px solid #334155; color: #fbbf24; border-radius: 4px; font-size: 9px; font-weight: 600; cursor: pointer; white-space: nowrap;"><i class="fa-solid fa-table"></i> Laporan</button>
      </div>
      ...
      <div class="card" style="padding: 6px; background: #0f172a; border: 1px solid #1e293b;">
        <div id="scrollContainerLaporan" style="overflow-x: auto; overflow-y: auto; max-height: calc(100vh - 240px); position: relative; border-radius: 6px;">
